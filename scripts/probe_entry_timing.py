...
## 第2回(2026-09-09 火 09:09 JST)の結果 — 火曜については決着した
...
■ ⚠ パーサーが探すのは pw01drl00 だが、火曜に載っているのは pw01drl10。
  00=今週分 / 10=過去分 らしい（結果ページも過去分は pw01srl10）。
  つまり火曜の空振りは「探し方が古い」のではなく「探すべきものがまだ無い」。
...
■ 🔴 未確認: 水曜・木曜のどこで出馬表が出るか。金曜夜は動くことが分かっている
