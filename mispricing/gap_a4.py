...
CUTS=[('f_jockey','lo'),('rl_f_speed_fig_max_vs_field','lo'),('rl_f_pl_rating','lo'),('cl_f_jockey_vs_field','lo'),('rl_f_pl_rating_rank','hi')]
def mask(c,side):
...
print(f'\n✅ 軸は探索期だけを見て選んだ（確認期は見ていない）。上表は確認期での評価＝out-of-sample。')
